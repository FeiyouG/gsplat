...
void launch_projection_ewa_simple_fwd_kernel(
    ...
    at::Tensor ray_planes, // [..., C, 2] optional
    at::Tensor normals     // [..., C, 3] optional
);
void launch_projection_ewa_simple_bwd_kernel(
    ...
    const at::Tensor v_ray_planes, // [..., C, 2] optional
    const at::Tensor v_normals,    // [..., C, 3] optional
    // outputs
...
void launch_projection_ewa_3dgs_fused_fwd_kernel(
    ...
    c10::optional<at::Tensor> ray_ts,       // [..., C, N] optional
    c10::optional<at::Tensor> ray_planes,   // [..., C, N, 2] optional
    c10::optional<at::Tensor> normals,      // [..., C, N, 3] optional
    const bool radegs
);
...
void launch_projection_ewa_3dgs_packed_fwd_kernel(
    ...
    at::optional<at::Tensor>
        block_cnts,                  // [B * C * blocks_per_row] packing helper
    ...
    c10::optional<at::Tensor> ray_ts,       // [nnz] optional
    c10::optional<at::Tensor> ray_planes,   // [nnz, 2] optional
    c10::optional<at::Tensor> normals,      // [nnz, 3] optional
    const bool radegs
);
void launch_projection_ewa_3dgs_packed_bwd_kernel(
    ...
    const c10::optional<at::Tensor> v_ray_ts,       // [nnz] optional
    const c10::optional<at::Tensor> v_ray_planes,   // [nnz, 2] optional
    const c10::optional<at::Tensor> v_normals,      // [nnz, 3] optional
